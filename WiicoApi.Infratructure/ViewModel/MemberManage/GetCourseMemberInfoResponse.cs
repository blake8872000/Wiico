...
{
    public class GetCourseMemberInfoResponse
    {
        /// <summary>
        /// 學生代號 - 帳號
        /// </summary>
        ...
        public string StudStatus
        {
            get
            {
                if (GraduationStatus.HasValue)
                {
                    ...
                    {
                        //畢業
                        case (int)ValueObject.GraduationStatus.graduation:
                            return "畢業";
                        //休學
                        case (int)ValueObject.GraduationStatus.off:
                            return "休學";
                        //在學
                        case (int)ValueObject.GraduationStatus.residence:
                            return "在學";
                        //退學
                        case (int)ValueObject.GraduationStatus.suspend:
                            return "退學";
                        default:
                            return null;
                    }
